...
public class HurtsEvenMorePanel extends JPanel {
    public HurtsEvenMorePanel (){
    ...
    public void paintComponent (Graphics g){
        ...
        //mouth 
        g.setColor(Color.BLACK); 
        g.drawArc(135,  180,  30, 15, 0, 180);
        
    
    }   //Ending bracket of paintComponent method

}   // Ending bracket of HurtsEvenMorePanel class
