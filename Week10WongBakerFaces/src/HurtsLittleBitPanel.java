...
public class HurtsLittleBitPanel extends JPanel {
    public HurtsLittleBitPanel (){
    ...
    public void paintComponent (Graphics g){
        ...
        //mouth 
        g.setColor(Color.BLACK); 
        g.drawArc(135,  180,  30, 15, -25, -120);
        
    }   //Ending bracket of paintComponent method

}   // Ending bracket of HurtsLittleBit class
